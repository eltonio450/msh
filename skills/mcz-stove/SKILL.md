...
**Cause probable :** accumulation de cendres / obstruction sous le brûleur.
Arrive assez fréquemment selon l'usage.

**Procédure de résolution :**
1. Éteindre le poêle et laisser refroidir.
2. Vider le petit bac à cendres situé sous le brûleur.
3. Remettre le bac en place.
4. Appuyer **au moins 5 secondes** sur le bouton situé à l'arrière du poêle,
   à côté de la LED rouge, pour effectuer le reset.
5. Le poêle devrait redémarrer normalement.
